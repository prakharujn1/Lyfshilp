  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 to-pink-100 p-4 md:p-8 font-sans">
      <div className="flex flex-col md:flex-row items-start justify-center gap-6">
        {/* LEFT SIDE: MAIN GAME CARD */}
        <div className="flex-1 max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl p-4 md:p-8 border-4 border-dashed border-yellow-300">
        ...
        <div className="mt-74 w-full md:w-1/3 flex items-center justify-center">
