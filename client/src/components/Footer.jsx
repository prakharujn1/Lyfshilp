          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 mb-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-4 mb-4">
                ...
                <div className="flex gap-2">
                  <a 
                    href="#" 
                    className="w-8 h-8 bg-white rounded-lg flex items-center justify-center text-sm font-bold hover:opacity-80 transition-opacity" 
                    style={{ color: '#068F36' }}
                    aria-label="LinkedIn"
                  >
                    in
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="/courses" className="text-sm hover:opacity-80 transition-opacity">
                    Courses
                  </a>
                </li>
                <li>
                  <a href="/blogs" className="text-sm hover:opacity-80 transition-opacity">
                    Blogs
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="/privacy-policy" className="text-sm hover:opacity-80 transition-opacity">
                    Privacy Policy
                  </a>
                </li>
                <li>
                  <a href="/terms-conditions" className="text-sm hover:opacity-80 transition-opacity">
                    Terms & Conditions
                  </a>
                </li>
                <li>
                  <a href="/refund-policy" className="text-sm hover:opacity-80 transition-opacity">
                    Refund Policy
                  </a>
                </li>
              </ul>
