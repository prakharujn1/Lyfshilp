...
const TortLawGame3 = () => {
  ...
  const cases = [
    {
      id: 1,
      title: "Hazardous Heights",
      description:
        "A construction site leaves debris unsecured on a rooftop. A strong gust causes it to fall and injure a passerby.",
      icon: "🏗️",
      color: "from-red-500 to-yellow-500",
    },
    {
      id: 2,
      title: "Fake Follower Frenzy",
      description:
        "An influencer pays for fake followers, misleading brands and gaining unfair sponsorship deals.",
      icon: "📱",
    ...
    },
    {
      ...
      title: "Toxic Tees",
      description:
        "A clothing company sells T-shirts dyed with harmful chemicals that cause allergic reactions.",
      icon: "👕",
    ...
    },
    {
      ...
      title: "Exam Leak",
      description:
        "An online education platform suffers a data breach, leaking answers to national competitive exams.",
      icon: "📝",
      color: "from-indigo-400 to-blue-500",
    },
    {
      id: 5,
      title: "Defective Drone",
      description:
        "A drone malfunctions mid-air due to faulty design and crashes onto a parked car, damaging it.",
      icon: "🚁",
    ...
    },
    {
      ...
      title: "Tenant’s Trap",
      description:
        "A landlord ignores repeated complaints about mold, resulting in a tenant's health deteriorating.",
      icon: "🏠",
  ...
  const challenges = {
    3: {
      title: "SPOT THE REMEDY",
      icon: <Heart className="w-8 h-8" />,
      color: "from-rose-500 to-fuchsia-600",
      answers: [
        {
          id: "A",
          text: "Medical Expenses + Pain & Suffering",
          color: "bg-red-100 hover:bg-red-200 border-red-300",
        },
        {
          id: "B",
          text: "Monetary Penalty + Public Disclosure",
          color: "bg-indigo-100 hover:bg-indigo-200 border-indigo-300",
        },
        {
          id: "C",
          text: "Product Recall + Consumer Compensation",
          color: "bg-green-100 hover:bg-green-200 border-green-300",
        },
        {
          id: "D",
          text: "Repair Damages + Design Review",
          color: "bg-yellow-100 hover:bg-yellow-200 border-yellow-300",
        },
        {
          id: "E",
          text: "Rent Reduction + Medical Support",
          color: "bg-slate-100 hover:bg-slate-200 border-slate-300",
        },
      ],
      correctAnswers: {
        1: "A", // Physical injury from falling debris
        2: "B", // Deceptive gain through fake followers
        3: "C", // Harmful product, needs recall
        4: "B", // Public harm, platform responsibility
        5: "D", // Property damage due to product defect
        6: "E", // Ongoing health issues from living condition
      },
    },
  };
  ...
  const GamePage = () => {
    ...
    if (!currentCase || !challenge) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100" style={{ fontFamily: "'Comic Neue', cursive" }}>
          Loading game...
        </div>
      );
    }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-200 via-yellow-200 to-green-200 p-4" style={{ fontFamily: "'Comic Neue', cursive" }}>
        {showCelebration && (
