    ...
    <div className="w-[50%] mx-auto">
      <div className="bg-yellow-50 p-3 shadow-2xl rounded-lg">
        ...
        <div className="max-w-2xl mt-5">
          <div
            className="p-2 shadow-lg text-xl bg-purple-100 rounded-lg
        "
          >
            Every time you borrow and pay back, the bank gives you a
            <strong> Credit Score</strong>.
          </div>
          <div className="bg-green-200 text-xl mt-2 p-2 shadow-lg rounded-lg">
            Good credit score = banks trust you and offer more credit.
          </div>
          <div className="bg-red-200 text-xl mt-2 p-2 shadow-lg rounded-lg">
