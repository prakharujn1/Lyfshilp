      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-navy-900 mb-4">
            Social-Learning Education Reimagined with Lyfshilp
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Our comprehensive social-learning curriculum is designed to
            transform your relationship with money and empower you with
            practical skills for lifelong financial success.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
          <div>
            <h3 className="text-2xl font-bold text-navy-800 mb-6">
              Why Learn Social-Learning with Us?
            </h3>
