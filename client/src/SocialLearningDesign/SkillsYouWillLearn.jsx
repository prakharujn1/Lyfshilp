...
const skills = [
  {
    title: "Self-Awareness & Growth Mindset",
    description:
      "Build confidence, understand your strengths, and develop the mindset to keep growing as a leader.",
  },
  {
    title: "Responsible Decision-Making",
    description:
      "Use critical thinking to solve problems ethically, weigh consequences, and align actions with core values.",
  },
  {
    title: "Empathy & Respectful Communication",
    description:
      "Learn to listen with empathy, express your ideas clearly, and connect across diverse perspectives.",
  },
  {
    title: "Collaboration & Team Leadership",
    description:
      "Practice healthy teamwork, positive peer interactions, and supportive delegation to achieve shared goals.",
  },
  {
    title: "Ethics, Fairness & Integrity",
    description:
      "Explore moral courage, tackle bias, and lead with fairness in challenging real-life scenarios.",
  },
  {
    title: "Visioning & Goal Setting",
    description:
      "Create meaningful goals, stay motivated, and turn your leadership vision into real action.",
  },
];
              ...
              {[
                {
                  ...
                  desc: "Grow with a supportive crew of peers, mentors, and educators through shared stories and experiences.",
                  bg: "#352A81",
                  img: "/imageForDesign/25.png",
                },
                {
                  title: "Step-by-Step SEL Journey",
                  desc: "Build emotional smarts and leadership confidence through fun, structured challenges.",
                  bg: "#E11D48",
                  img: "/imageForDesign/27.png",
                },
                {
                  title: "Real-Life Skill Building",
                  desc: "Practice real-world skills like empathy, teamwork, and problem-solving through interactive games.",
                  bg: "#2542AA",
                  img: "/imageForDesign/26.png",
                },
                {
                  title: "Confidence-Boosting Certification",
                  desc: "Earn badges that show how far you’ve come—great for school, portfolios, or just self-pride.",
                  bg: "#B81563",
