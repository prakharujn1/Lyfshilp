...
const skills = [
  {
    ...
    description:
      "Speak clearly, use tone effectively, and master body language cues.",
  },
  {
    title: "Active Listening Techniques",
    description:
      "Learn to listen with intent, ask thoughtful questions, and show empathy.",
  },
  {
    title: "Public Speaking & Presentation Skills",
    description:
      "Gain confidence in presenting ideas and speaking to groups of any size.",
  },
  {
    title: "Writing for Impact",
    description:
      "Write emails, essays, and messages that are clear, persuasive, and engaging.",
  },
  {
    title: "Conflict Resolution & Assertiveness",
    description:
      "Navigate tough conversations with confidence and stand up respectfully.",
  },
  {
    title: "Digital Communication Etiquette",
    description:
      "Communicate effectively and respectfully in online spaces—chats, emails, and social media.",
  },
];
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-start gap-6">
              ...
              {[
                {
                  ...
                  desc: "Connect with peers and mentors to practice communication in collaborative and supportive environments.",
                  bg: "#352A81",
                  img: "/imageForDesign/25.png",
                },
                {
                  title: "Step by Step Guidance",
                  desc: "Build your communication skills progressively—from basic speaking and listening to persuasive presentations.",
                  bg: "#E11D48",
                  img: "/imageForDesign/27.png",
                },
                {
                  title: "Practical, Real World Focus",
                  desc: "Engage in real-life scenarios, roleplays, and simulations that make communication meaningful and actionable.",
                  bg: "#2542AA",
                  img: "/imageForDesign/26.png",
                },
                {
                  title: "Industry-Level Certification",
                  desc: "Showcase your communication skills with certificates recognized by educators and future employers alike.",
                  bg: "#B81563",
            ...
            <div className="flex flex-col justify-start w-full max-w-[750px]">
              ...
              <div className="mt-6 rounded-xl overflow-hidden shadow-md h-[220px] sm:h-[280px] md:h-[608px]">
                <video
                  ref={videoRef}
