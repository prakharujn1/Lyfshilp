      ...
      <div className="md:hidden bg-[#FFD86B] rounded-2xl p-6 flex flex-col items-center text-center">
        ...
        <p className="text-gray-800 text-sm mb-4">
          <span>
            ...
            think like entrepreneurs. With every lesson, they’ll take their
            first bold steps toward identifying real-world problems, generating
            ideas, building solutions, and developing the confidence to lead—
        ...
        <div className="max-w-xl flex-1 text-left">
          ...
          <p className="text-gray-800 text-base mt-12">
            <span>
              ...
              characters are designed to spark curiosity and inspire students to
              think like entrepreneurs. With every lesson, they’ll take their
              first bold steps toward identifying real-world problems,
              generating ideas, building solutions, and developing the
              confidence to lead— all while having fun!
            </span>
          </p>
        </div>
