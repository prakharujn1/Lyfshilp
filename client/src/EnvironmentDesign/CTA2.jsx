      ...
      <div className="md:hidden bg-[#FFD86B] rounded-2xl p-6 flex flex-col items-center text-center">
        ...
        <p className="text-gray-800 text-sm mb-4">
          <span>
            ...
            ideas, building eco-friendly solutions, and developing the
            confidence to lead change — all while having fun!
          </span>
        </p>
        <Link to="/login">
        ...
        <div className="w-1/2 text-left">
          ...
          <p className="text-gray-800 text-base mt-12">
            <span>
              Our creativity tools, interactive story-based lessons, and fun
              characters are designed to spark curiosity and inspire students to
              become green innovators. With every lesson, they’ll take bold
              steps toward identifying environmental challenges, generating
              sustainable ideas, building eco-friendly solutions, and developing
              the confidence to lead change — all while having fun!
            </span>
          </p>
        </div>
