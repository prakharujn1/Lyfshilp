...
const skills = [
  {
    ...
    description:
      "Develop self-awareness, confidence, and the courage to lead with purpose.",
  },
  {
    title: "Critical Thinking & Decision-Making",
    description:
      "Analyze complex scenarios and make thoughtful, values-driven choices.",
  },
  {
    title: "Empathy & Communication",
    description:
      "Learn how to listen deeply, speak with clarity, and collaborate across differences.",
  },
  {
    title: "Teamwork & Delegation",
    description:
      "Understand how to assign roles, manage group dynamics, and motivate teams effectively.",
  },
  {
    title: "Ethics & Integrity in Leadership",
    description:
      "Explore fairness, bias, and moral courage through real-world dilemmas.",
  },
  {
    title: "Vision & Goal Setting",
    description:
      "Practice creating action plans, setting SMART+ER goals, and leading with direction.",
  },
];
              ...
              {[
                {
                  ...
                  desc: "Join a vibrant community of future leaders, educators, and mentors to grow together.",
                  bg: "#352A81",
                  img: "/imageForDesign/25.png",
                },
                {
                  title: "Step-by-Step Leadership Journey",
                  desc: "Follow structured learning paths that guide you from foundational leadership skills to advanced impact strategies.",
                  bg: "#E11D48",
                  img: "/imageForDesign/27.png",
                },
                {
                  title: "Practical, Real-World Focus",
                  desc: "Bridge leadership theory and action through role-play challenges, dilemmas, and team simulations.",
                  bg: "#2542AA",
                  img: "/imageForDesign/26.png",
                },
                {
                  title: "Impact-Ready Certification",
                  desc: "Earn certificates that validate your leadership growth and strengthen your future academic or career journey.",
                  bg: "#B81563",
