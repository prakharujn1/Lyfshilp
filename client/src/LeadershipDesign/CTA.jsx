...
const CTA = () => {
  ...
  const loggedInDescription = `Develop leadership skills through games that focus on decision-making, team management, goal-setting, and emotional intelligence.
Students take on real-world leadership scenarios, practice conflict resolution, and receive feedback through AI-based evaluations.`;
